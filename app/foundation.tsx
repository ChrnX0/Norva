 ...
 *
 * Kept out of the way of the real screens but not deleted: it is the one place
 * that exercises the ledger, the packaging hierarchy, the locale formatting and
 * the motion vocabulary together on a real device.
 *
