## Apêndice B — `CLAUDE.md`: as regras do projeto, verbatim

Este arquivo era lido no início de toda sessão de trabalho e é a fonte de quase toda decisão
registrada. Está aqui sem edição; só os títulos foram rebaixados para caber na hierarquia do
dossiê.
