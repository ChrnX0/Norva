## Apêndice G — `docs/insights.md`, verbatim

O registro de aprendizados, sem edição. Toda rodada de trabalho terminava com a pergunta "o que
apareceu aqui que ninguém tinha visto?", e a resposta virava uma linha aqui — com o que se viu,
por que importa e o que mudou por causa disso. Achado sem consequência não entrava. As seções 30
e 31 catalogam este arquivo; isto é a fonte.
