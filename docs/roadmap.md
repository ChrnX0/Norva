...
|---|---|
| `npm test` | **767** testes |
| `npm run mutate` | **134** defeitos plantados — o número é derivado do arquivo; o resultado da última execução está abaixo da tabela, com data, porque ele NÃO é derivado de nada |
