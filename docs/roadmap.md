...
| **2b** | **A conta da empresa — a camada 2** | cliente Supabase, sessão, cadastro do dono, convite por código. Espera a sincronia existir de verdade: sem ela, é pagar projeto para uma tela de entrar que não leva a lugar nenhum. Três perguntas para o dono estão no fim do estudo. |
