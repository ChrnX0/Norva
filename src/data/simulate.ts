    ...
    if (acucar && glucose && leite) {
      ...
      for (const novo of novos) {
        ...
        await saveProduct(companyId, {
          ...
          lineId: linha,
          typeId: novo.tipo,
          flavorId: await saveFlavor(companyId, { lineId: linha, typeId: novo.tipo, name: novo.sabor }),
      ...
      if (morango) {
        await saveProduct(companyId, {
          ...
          lineId: linha,
          typeId: agua,
          flavorId: await saveFlavor(companyId, { lineId: linha, typeId: agua, name: 'Morango' }),
        });
      }
