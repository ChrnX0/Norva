...
export const en: Dictionary = {
  ...
  app: {
    ...
    home: {
      ...
      hourCount: { one: '1 hour', other: '{{n}} hours' },
    ...
    settings: {
      ...
      safety: {
        ...
        suggest: 'You have always bought with {{observed}} to spare. Warn you with {{suggested}}?',
        suggestAction: 'Use {{days}}',
      },
      briefing: {
      ...
      alerts: {
        ...
        kinds: {
          ...
          semMedida: 'Room stopped measuring',
        ...
        semMedidaHint: 'Warns when the room goes longer than you choose with no reading at all. Turn it on if a sensor measures on its own; if someone writes it down by hand, it will warn every weekend.',
        staleHours: 'After {{hours}} with no reading',
    ...
    buyToday: {
      title: 'Buy today',
      overline: "by each supplier's lead time",
      loading: 'Checking the stock…',
      estimate: 'SHOULD COST',
      estimateWhy: 'From each one\'s last invoice. The price may have moved — the purchase screen compares.',
      estimateNoMoney: 'These are the packs to order. Cost does not show for this access.',
      itemCount: { one: '1 item', other: '{{n}} items' },
      listTitle: 'WHAT TO ORDER',
      howMuch: '{{packs}} × {{pack}} — {{amount}}',
      daysLeft: 'lasts {{days}} d',
      dayCount: { one: '1 day', other: '{{n}} days' },
      why: '{{rate}} goes out a day, {{held}} left, {{supplier}} takes {{lead}} and you buy from them every {{cycle}}.',
      whyNoCycle: '{{rate}} goes out a day, {{held}} left and {{supplier}} takes {{lead}}. This is the first reorder from them.',
      whyNoSupplier: '{{rate}} goes out a day and {{held}} is left. No supplier recorded yet: the maths uses the slack from settings.',
      emptyTitle: 'Nothing to buy today',
      empty: 'Everything has stock past its supplier lead time.',
      emptyWhy: 'This list shows up when an input reaches its order day. Until then, all is well.',
      goToInputs: 'See the stock',
    },
  ...
  alertText: {
    ...
    semMedida: {
      title: '{{subject}} stopped measuring',
      body: 'No reading for {{amount}}. Check the sensor — the last one read {{reading}} °{{unit}}.',
    },
    ambiente: {
      title: '{{subject}} out of range',
      aboveMax: '{{amount}} °{{unit}}, and the top is {{limit}}. Check the door and the motor.',
      belowMin: '{{amount}} °{{unit}}, and the floor is {{limit}}. Check the door and the motor.',
      justNow: 'Read just now.',
      measuredAgo: 'Read {{hours}} ago.',
    },
  },
