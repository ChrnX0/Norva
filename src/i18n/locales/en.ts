...
export const en: Dictionary = {
  common: {
    ...
    moneyHiddenWay:
      "If this phone is yours, switch the name under Who has this phone.",
  },
  ...
  app: {
    ...
    home: {
      ...
      ordersCoveredDetail:
        "What was asked for by {{date}} fits in what the factory already holds.",
      ordersWhy:
        "From what was ordered through {{date}}, against what the factory holds. Tap to see the orders.",
      orderCount: { one: "1 order", other: "{{n}} orders" },
      runningOutWhy:
        "From the last seven days of usage. Tap to see the storeroom.",
      levelFull: "full",
      levelLasts: "lasts {{days}} at this week\u2019s pace",
      levelEndsIn: "runs out in {{days}}",
      inputsFine: "Inputs are fine",
      inputsFineDetail:
        "At the last few weeks of usage, nothing runs out in the next seven days.",
      each: "each",
      ...
      capaLegendStill:
        "Still right now: no vat open, nothing made and nothing shipped today.",
      ...
      firstDayBody:
        "The cover fills itself as the factory works: what came out today, what is running low, what customers ordered.",
      firstDayAction: "Record the first production",
      copyNeverTitle: "Keep a copy",
      copyNeverBody:
        "Everything the factory recorded lives on this device. If it breaks, that goes with it.",
      copyOldTitle: "Your copy is {{days}} days old",
      copyOldBody:
        "{{movements}} came in after it — that is what is lost if the device disappears.",
      copyOldQuiet:
        "Nothing came in after it, but the device is still the only place.",
      ...
      nav: {
        ...
        purchases: {
          label: "Purchases",
          hint: "the invoice that moves the cost",
        },
    ...
    reports: {
      ...
      rows: {
        ...
        mirror: {
          label: "Store Mirror",
          detail: "how much comes back from each",
        },
      },
      mirror: {
        title: "Store Mirror",
        ...
        emptyHint:
          "As soon as the first load goes out, this screen starts comparing.",
      },
    },
    ...
    picking: {
      ...
      emptyHint:
        "With no order, the load is a top-up — and the transfer screen handles that.",
      noPlacesTitle: "Nowhere to send it yet",
      noPlacesHint:
        "Picking a load needs a destination. Add your first shop or customer — it takes a minute, and after that you just pick it here.",
      ...
      confirmBody:
        "{{count}} go at once. The balance leaves the factory and enters the store, one entry per item.",
      confirmAction: "Send",
      ...
      clearBody:
        "What was counted is lost. Nothing was recorded yet, so nothing is undone — the cart simply goes back to empty.",
    ...
    lotLabel: {
      ...
      findLabel: "Lot code",
      findHint:
        "Type the code on the box — the same one printed under the square.",
      ...
      reverseBody:
        "{{out}} leaves stock. {{back}} goes back to the storeroom. Both entries stay in the history — nothing is erased.",
      ...
      reverseBlockedHint:
        "Bring the load back first, then the correction goes through.",
    ...
    backup: {
      ...
      neverHint:
        "A copy is one file. Keep it where you already keep what matters — your own chat, email, cloud.",
      ...
      madeBody:
        "The copy holds {{movements}} and weighs {{size}}. Now choose where to keep it.",
      share: "Choose where to keep it",
      inside: "What goes inside",
      insideBody:
        "The copy carries the whole ledger — what came in, what went out, costs and suppliers. Whoever opens the file reads all of it: today that is {{movements}}.",
      insideBodyEmpty:
        "The copy carries the whole ledger — what came in, what went out, costs and suppliers. Whoever opens the file reads all of it.",
      insidePrefs:
        "Your choices come along: weather city, cover order, how people sign in. On a new device that is what makes it feel like the old one.",
      ...
      confirmBody:
        "The copy is from {{when}} and holds {{copyMovements}}. This device has {{hereMovements}} now, and they will be replaced by the ones in the copy.",
      confirmNoDate:
        "The copy holds {{copyMovements}}. This device has {{hereMovements}} now, and they will be replaced by the ones in the copy.",
      ...
      maisNovaQueOApp:
        "This copy came from a newer version of the app. Update the app and try again — bringing back only what it understands would leave the factory missing a part of itself.",
      ilegivel: "This file did not open. It may have arrived incomplete.",
      referenciasQuebradas:
        "This copy is inconsistent and nothing was changed. The device is as it was.",
      naoDeuParaGuardar: "The copy could not be kept right now.",
      semPartilha:
        "This device cannot share a file. The copy is kept here: {{path}}",
    },
    extract: {
      title: "Ledger",
      ...
      emptyHint:
        "Every purchase, run, load and count shows up here — with the way back beside it.",
      ...
      undoTitle: "Undo {{what}}?",
      undoBody:
        "Leaves stock: {{out}}. Comes back to stock: {{back}}. Both entries stay in the history — nothing is deleted.",
      nothing: "nothing",
      alreadyUndone:
        "This was already undone. Undoing twice would double the correction.",
    ...
    losses: {
      ...
      emptyHint:
        "When something expires, melts or breaks, record it on the item — the reason is what makes this screen useful.",
      ...
      firstWindow:
        "first window with any loss on the books — nothing before to compare",
    ...
    orders: {
      ...
      emptyHint:
        "Write down what a customer asks for. The home screen then says what is left to make by the agreed day.",
      forDate: "for {{date}}",
      ...
      cancelBody:
        "The order for {{place}} leaves the list. Nothing changes in stock: an order moves no boxes.",
    },

    newOrder: {
      free: "free for this date: {{amount}}",
      freeHint:
        "what is in the freezer minus what is already promised up to that day",
      ...
      confirmBody:
        "You are taking {{items}} for {{place}}, {{when}}. Nothing leaves stock now.",
    ...
    account: {
      ...
      checkEmail:
        "Account created. Confirm it through the link sent to your email, then come back to sign in.",
      companyTitle: "Your company",
      companyBody:
        "It still needs a name. This is what shows at the top of the app and on reports.",
      ...
      joinAsk: "Ask to join",
      joinSent:
        "Request sent to {{company}}. Wait for someone there to approve it.",
      waitingTitle: "Waiting on you",
      waitingNone: "Nobody has asked to join.",
      approve: "Approve",
      refuse: "Decline",
      approveAs:
        "joins as operator — makes, ships and counts, without seeing money",
      signOut: "Sign out",
      ...
      adoptRefuse: {
        idVazio:
          "The company came back with no id from the server. Sign out, sign in, and try again.",
        jaSubiu:
      ...
      reason: {
        ...
        senhaFraca:
          "That password is too short. Use at least 6 letters or numbers.",
        emailNaoConfirmado:
          "The email is not confirmed yet. Look for the link the server sent.",
        codigoNaoConfere:
          "That code does not belong to any company. Check the six letters.",
        desconhecido:
          "It did not work, and the reason is not one of the known ones.",
      },
    },
    weather: {
    ...
    weatherPlace: {
      ...
      offline:
        "No internet right now. Searching for a city needs it; the rest of the app does not.",
    ...
    settings: {
      ...
      clearByAreaHint:
        "One area at a time, when you only want to redo part of it.",
      areas: {
      ...
      blocked: {
        recipesUseInputs: {
          ...
          other:
            "The inputs cannot go while {{n}} recipes use them. Erase the recipes first.",
        },
        purchasesUseInputs: {
          one: "The inputs cannot go while 1 recorded purchase points at them. Erase the purchases first.",
          other:
            "The inputs cannot go while {{n}} recorded purchases point at them. Erase the purchases first.",
        },
        productsUseRecipes: {
          one: "The recipes cannot go while 1 product is made from them. Erase the products first.",
          other:
            "The recipes cannot go while {{n}} products are made from them. Erase the products first.",
        },
      ...
      alsoPurchases:
        "This erases {{what}}, and zeroes the average cost of every input — they have no price until the next invoice. A movement is the record of everything in and out: production, counts, losses and transfers go with it.",
      alsoRecipes:
        "This erases {{what}}, with every version and line of them. The version history goes too.",
      alsoInputs:
        "This erases {{what}}, along with their average cost and price history.",
      alsoAll:
        "This erases {{what}}. The app opens empty again, and the example data does not come back on its own.",
      counted: {
        inputs: { one: "1 input", other: "{{n}} inputs" },
        movements: {
          one: "1 ledger movement",
          other: "{{n}} ledger movements",
        },
        ...
        people: {
          one: "1 registered person",
          other: "{{n}} registered people",
        },
      ...
      language: {
        ...
        currency: "Currency",
        currencyHint:
          "It decides the symbol AND how the number is written. The example beside each one is the same amount.",
      },
      appearance: {
        ...
        lightHint:
          "Light is the default. Pick dark for the cold room, or let the phone decide.",
        peles: {
        ...
        paletteHint:
          "Changes the sky and the hill. The up and down signals stay put — they are reading, not decoration.",
        hues: {
          verde: "Green",
          azul: "Blue",
          ambar: "Amber",
      ...
      alerts: {
        ...
        ambienteHint:
          "Compares against the range you set on the room. With no range it stays quiet — the app does not know what temperature your room should hold.",
        notifyFull: "Warn when it fills up",
        volumeHint:
          "Compares against the range you set on the item. With no range, it stays quiet.",
        hour: "Time of the alert",
        hourField: "Hour",
        minuteField: "Minute",
        hourHint:
          "Before the shift starts. A small-hours alert is an alarm clock, and a phone that wakes someone becomes a silenced phone.",
        weekdays: "On which days",
        everyDay: "every day",
        on: "On",
        off: "Off",
        never:
          "This phone did not grant notification permission. The app stays whole — the cover shows the same arithmetic.",
      },
      approval: {
    ...
    inputs: {
      ...
      coverUnknown:
        "no usage on the books yet — nobody knows how long this lasts",
    ...
    inputForm: {
      ...
      kindHint: {
        ...
        storeSupply:
          "Cup, spoon, napkin — costs money at the shop, but never enters a recipe.",
      },
      howYouBuy: "How you buy it",
      howYouBuyHint:
        "The way it comes from the supplier, not the way it goes into a recipe.",
      pack: "Pack",
      ...
      fullLevelHint:
        "Only if you want the colour reading: red, yellow, green, blue. Left empty, the item gets no colour and no volume alert.",
      ...
      conversionDiffers:
        "The pack says {{pack}} {{unit}}, the field says {{typed}}. Check it.",
      fillFirst:
        "Fill in how much is inside and the price so the app can work out the cost per unit of use.",
      fillInside:
        "How much is inside is missing: it is what the price is divided by.",
      fillPrice:
        "The price paid is missing. With it the app works out the cost per unit of use.",
      save: "Save record",
    ...
    inputDetail: {
      ...
      buyCalmWhy:
        "{{cover}} of stock left, and the sum already counts the supplier lead time.",
      leadTimeUnknown:
      ...
      lossHint:
        "Record it with the reason. The reason is what makes the report worth reading.",
      ...
      lossBody:
        "This takes {{amount}} of {{item}} off the shelf: {{reason}}. It is worth {{money}}, and it stays on the record.",
      lossBodyNoMoney:
        "This takes {{amount}} of {{item}} off the shelf: {{reason}}. It stays on the record.",
      ...
      entriesHint:
        "Tap an entry to undo it. Nothing is deleted: the correction is a new line, and both stay.",
      ...
      undoDoneBody:
        "Its correction is already on record. It is not corrected twice.",
      ...
      historyEmpty:
        "There has only been one purchase so far, so there is nothing to compare yet.",
      usedBy: "What uses it",
      usedByOne: "One recipe depends on this item.",
      usedByMany:
        "{{count}} recipes depend on this item — a rise here moves all of them.",
    ...
    places: {
      ...
      factory: "Factory",
      empty:
        "Nothing has arrived anywhere yet. Enter an invoice or record a production run.",
      worth: "worth {{amount}}",
      itemCount: { one: "one item", other: "{{n}} items" },
      placeCount: { one: "in 1 place", other: "in {{n}} places" },
      agreement: "What was agreed",
      agreementHint:
        "None of it is required — with no agreement, the store gets what it gets.",
      ...
      pricesHint:
        "Blank means the list price applies. What you write here beats the list, for this place only.",
      listPrice: "list {{amount}}",
      noListPrice: "no list price",
      priceWas: "was {{amount}} until {{date}}",
      pricePerUnit: "per {{unit}}",
      agreementNoteHint:
        "One sentence: where to unload, who to ask for, what to avoid.",
      noAgreement: "no agreed day",
      agreedDays: "delivers {{days}}",
      reading: "Temperature now",
      readingHint:
        "Note it when you pass by the room. It becomes history — and when the sensor arrives, it writes to the same place.",
      readingSave: "Save reading",
      lastReading: "last: {{value}} at {{time}}",
      noReading: "no reading noted yet",
      rangeLabel: "Acceptable range",
      rangeHint:
        "With no range the app records and does not judge — it does not know what temperature your room should hold.",
      rangeMin: "min",
      rangeMax: "max",
      ...
      keep: "Leave it",
      onlyAdminEdits:
        "Adding and renaming places is for whoever runs the company.",
      ...
      placeNameHint:
        "The name the team uses. It can change later without touching a balance.",
    ...
    transport: {
      ...
      emptyHint:
        "Whatever goes to a store or a customer shows up here, by destination.",
    ...
    capabilities: {
      view_cost: {
        label: "See cost",
        hint: "What it costs to make, and what the stock is worth.",
      },
      view_sale_price: {
        label: "See sale price",
        hint: "What the goods go out for, to a store or a customer.",
      },
      record_production: {
        label: "Record production",
        hint: "Enter what came out of the pot, drawing down the inputs.",
      },
      dispatch: {
        label: "Send a load",
        hint: "Move goods from the factory to a store.",
      },
      check_receipt: {
        label: "Check arrivals",
        hint: "Open the box at the store and say what came.",
      },
      record_loss: {
        label: "Record a loss",
        hint: "Note what melted, broke or went past its date.",
      },
      place_order: {
        label: "Write an order",
        hint: "Order from the factory for a store.",
      },
      approve_order: {
        label: "Approve an order",
        hint: "Let an order become a load.",
      },
      adjust_stock: {
        label: "Count the shelf",
        hint: "Count what is there and record the difference.",
      },
      view_finance: {
        label: "See the money",
        hint: "What came in, what went out, what is sitting still.",
      },
      issue_invoice: {
        label: "Issue an invoice",
        hint: "Make out the tax invoice for a load.",
      },
      manage_company: {
        label: "Run the company",
        hint: "Register people, profiles, stores and devices.",
      },
    },
    ...
    people: {
      ...
      emptyHint:
        "Register who works here so you can say, later, who was holding the phone.",
      ...
      awayHint:
        "They leave the list and the history still points at them — nothing is deleted.",
    ...
    transfer: {
      ...
      closeBody:
        "What left for that store today covers {{count}} still open. Closing takes it off the picking list and off what is left to make.",
      closeAction: "Close",
      ...
      returnBody:
        "You are bringing {{amount}} of {{item}} back from {{place}} to the factory.",
      ...
      orderedPartly:
        "ordered for {{date}}: {{amount}} — {{sent}} already went today",
      title: "Transfer",
      overline: "what leaves the factory",
      returnReason: "Why it came back",
      returnReasonHint:
        "The answer changes what to do: unsold means make less for that store; melted means check the van.",
      unsold: "Did not sell",
      ...
      notASale:
        "An own store is a transfer, not a sale: there is no revenue and no margin here. The value just changes rooms.",
      ...
      promised:
        "{{amount}} of that is already spoken for: {{place}} is waiting {{when}}",
      promisedMany:
        "{{amount}} of that is already spoken for: {{place}} is waiting {{when}}, and {{rest}} more",
      ...
      confirmShort:
        "After this load, {{amount}} is missing for who is waiting.",
      send: "Record the transfer",
      sending: "Recording…",
      confirmTitle: "Confirm the transfer",
      confirmBody:
        "You are sending {{amount}} of {{item}} from {{from}} to {{to}}. The balance leaves one place and enters the other; the company still has the same thing.",
      confirmAction: "Send",
    ...
    production: {
      ...
      nothingYet:
        "Nothing recorded today yet. Tap add when the first box is closed.",
      ...
      batchesHint:
        "Each run yields {{yield}}. This is what decides how much leaves the storeroom.",
      units: "How many units came out",
      packedAs: "that is {{packed}}",
      unitsHint:
        "What actually came out. If it yielded less than planned, the loss shows up here.",
      ...
      confirmBodyNoBatchNoCost:
        "You made {{units}} of {{product}}. That takes {{lines}} out of stock.",
      recorded: "Production recorded.",
      open: "Start now",
      openHint:
        "Mark it now and close it when it comes out, or record it all at once.",
      close: "Close the production",
      running: "Under way since {{time}}",
      cancel: "Cancel",
      cancelTitle: "Cancel this production?",
      cancelBody:
        "Nothing has been recorded yet, so there is nothing to reverse.",
      ...
      missingElsewhere:
        "There is {{item}}: {{where}}. Bring it to the storeroom before you run.",
      missingIn: "in",
    },
    purchase: {
      title: "New purchase",
      ...
      conversion:
        "{{packs}} × {{factor}} = {{baseUnits}} {{unit}} going into stock.",
      total: "Invoice total",
      perPack: "{{price}} per {{pack}}",
      beforeClosing: "BEFORE YOU CLOSE",
      firstPurchase:
        "First purchase of this item. The next one comes with the comparison.",
      ...
      averageMoves:
        "The average cost of {{name}} moves from {{from}} to {{to}} per 1,000 {{unit}}.",
    ...
    recipes: {
      ...
      empty:
        "No recipe yet. Register the inputs first, then the recipe that uses them.",
      ...
      orderedByBatch:
        "In order of what a batch costs — dearest first, which is where a change pays most.",
    },
    ...
    recipe: {
      ...
      cheaperThan:
        "{{amount}} per unit against version {{version}} ({{percent}})",
      roundUp:
        "Make {{rounded}} to fill whole boxes — {{loose}} would be left loose out of {{units}}.",
      why: "WHY?",
      ...
      summaryCheaper:
        "It comes out {{amount}} per unit cheaper than version {{version}}.",
      summaryDearer:
        "It goes up {{amount}} per unit against version {{version}}.",
    ...
    products: {
      ...
      opening: "Opening…",
      empty:
        "No product yet. A manufactured product needs a recipe and how much goes into each unit.",
    ...
    catalog: {
      duplicate:
        "That name is already registered. Case and spacing do not make it different.",
      ...
      typesTitle: "Types",
      typesHint:
        "what splits the line: Traditional, Coated, Premium — or 240 ml, 500 ml, 1 litre",
      flavors: "Flavours",
      ...
      noLines:
        "No lines yet. Start with the obvious one: what do you make every day?",
      noTypes:
        "No types in this line. No type works too — the product is just line and flavour.",
      ...
      typeFromAnotherLine:
        "That type belongs to another line. Pick its line, or a type from this one.",
    },
    ...
    productForm: {
      ...
      resale: "Resale",
      madeHint:
        "The cost comes from the recipe and updates itself when an input changes price.",
      resaleHint:
        "The cost comes from the purchase invoice, at the suppliers average.",
      ...
      perUnitShort: "/ unit",
      packagingHint:
        "Packaging costs per unit, not per batch — smearing it across the batch hides the margin.",
      fromStock: "What leaves stock per unit",
      fromStockCost:
        "the listed packaging costs {{amount}} per unit, from the purchase invoices",
      perUnitOf: "How much {{item}} per unit",
      howPacked: "How it is packed",
      howPackedHint:
        "Stock always counts in units; the screens speak in your packaging.",
      ...
      unitCost: "COST PER UNIT",
      mixPlusBoth:
        "{{mix}} of mix + {{stock}} of packaging from stock + {{packaging}} typed in",
      ...
      confirmMade:
        "{{name}}, made from the recipe {{recipe}}, {{perUnit}} ml per unit. {{packaging}}",
      confirmResale: "{{name}}, a resale product. {{packaging}}",
      confirmAction: "Register",
      gridTaken:
        "{{name}} already has this classification. Give one of the two a line, type or flavour — the catalogue is in Settings.",
  ...
  alertText: {
    insumo: {
      title: "Buy {{subject}}",
      body: "Runs out in {{amount}} at this week usage.",
    },
    pedido: {
      title: "{{places}} waiting for a load",
      body: "{{amount}} of {{subject}} short.",
    },
    volume: {
      title: "{{subject}} at {{amount}}%",
      body: "Of the full level you set.",
    },
    validade: {
      title: "Lot {{subject}} expires",
      body: "In {{amount}} — send that one first.",
    },
    ambiente: {
