...
export const es: Dictionary = {
  ...
  app: {
    ...
    newOrder: {
      free: 'libre hoy: {{amount}}',
      freeHint: 'lo que hay en el congelador menos lo ya prometido para esta fecha',
      over: 'Eso promete {{amount}} más de lo que existe hoy. ¿Da tiempo de producirlo?',
      title: 'Anotar pedido',
    ...
    settings: {
      ...
      alerts: {
        ...
        hint: 'Cada aviso se enciende solo y tú eliges la antelación. La app avisa el día en que todavía se puede decidir, no el del problema.',
        kinds: {
