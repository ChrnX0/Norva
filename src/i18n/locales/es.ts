...
export const es: Dictionary = {
  common: {
    ...
    moneyHiddenWay:
      "Si este teléfono es tuyo, cambiá el nombre en Quién tiene el teléfono.",
  },
  ...
  app: {
    ...
    home: {
      ...
      ordersCoveredDetail:
        "Lo pedido hasta el {{date}} cabe en lo que ya hay en la fábrica.",
      ordersWhy:
        "Por lo pedido hasta el {{date}}, contra lo que hay en la fábrica. Toca para ver los pedidos.",
      orderCount: { one: "1 pedido", other: "{{n}} pedidos" },
      runningOutWhy:
        "Por la salida de los últimos siete días. Toca para ver el almacén.",
      levelFull: "lleno",
      levelLasts: "dura {{days}} al ritmo de la semana",
      levelEndsIn: "se acaba en {{days}}",
      inputsFine: "Insumos al día",
      inputsFineDetail:
        "Por el consumo de las últimas semanas, nada se acaba en los próximos siete días.",
      each: "cada uno",
      ...
      capaLegendStill:
        "Parada ahora: sin paila abierta, nada hecho y nada salió hoy.",
      boxYesterday: "Ayer",
      ...
      firstDayBody:
        "La portada se llena sola conforme la fábrica trabaja: lo que salió hoy, lo que se está acabando, lo que pidieron los clientes.",
      firstDayAction: "Registrar la primera producción",
      copyNeverTitle: "Guarde una copia",
      copyNeverBody:
        "Todo lo que la fábrica registró vive en este aparato. Si se rompe, se va con él.",
      copyOldTitle: "Su copia tiene {{days}} días",
      copyOldBody:
        "Entraron {{movements}} después de ella — eso es lo que se pierde si el aparato desaparece.",
      copyOldQuiet:
        "Nada entró después de ella, pero el aparato sigue siendo el único lugar.",
      ...
      unitCost:
        "costo por unidad · calculado de la receta y de las facturas de compra",
      ...
      nav: {
        ...
        settings: {
          label: "Ajustes",
          hint: "limpiar datos y empezar de nuevo",
        },
      },
    },
    tabs: {
    ...
    reports: {
      ...
      rows: {
        ...
        mirror: {
          label: "Espejo de la Tienda",
          detail: "cuánto vuelve de cada una",
        },
      },
      mirror: {
        ...
        emptyHint:
          "En cuanto salga la primera carga, esta pantalla empieza a comparar.",
      },
    },
    ...
    picking: {
      ...
      emptyHint:
        "Sin pedido, la carga es reposición — y la pantalla de transferir se encarga.",
      noPlacesTitle: "Todavía no hay a dónde mandar",
      noPlacesHint:
        "Separar carga necesita un destino. Registre la primera tienda o cliente — lleva un minuto, y después solo se elige aquí.",
      ...
      confirmBody:
        "Van {{count}} de una vez. El saldo sale de la fábrica y entra en la tienda, un asiento por ítem.",
      ...
      clearBody:
        "Lo contado se pierde. Nada fue grabado todavía, así que nada se deshace — el carro vuelve a estar vacío.",
    ...
    lotLabel: {
      ...
      findHint:
        "Escribe el código de la caja — el mismo que aparece debajo del cuadrado.",
      ...
      reverseBody:
        "Sale del stock {{out}}. Vuelve al almacén {{back}}. Los dos registros quedan en el historial — no se borra nada.",
      ...
      reverseBlockedHint:
        "Traiga la carga de vuelta primero, y la corrección pasa a valer.",
    ...
    backup: {
      ...
      neverHint:
        "Una copia es un archivo. Guárdelo donde ya guarda lo que importa — su propio chat, correo, nube.",
      ...
      madeBody:
        "La copia guarda {{movements}} y pesa {{size}}. Ahora elija dónde guardarla.",
      share: "Elegir dónde guardarla",
      inside: "Lo que va dentro",
      insideBody:
        "La copia lleva el libro mayor completo — lo que entró, lo que salió, costos y proveedores. Quien abra el archivo lee todo eso: hoy son {{movements}}.",
      insideBodyEmpty:
        "La copia lleva el libro mayor completo — lo que entró, lo que salió, costos y proveedores. Quien abra el archivo lee todo eso.",
      insidePrefs:
        "Sus elecciones vienen junto: ciudad del clima, orden de la portada, cómo se entra. En un aparato nuevo es eso lo que lo hace parecer el antiguo.",
      restoreTitle: "Traer una copia de vuelta",
      restoreLead:
        "Aparato nuevo, o aparato formateado. Elija el archivo de la copia.",
      ...
      confirmBody:
        "La copia es del {{when}} y guarda {{copyMovements}}. Este aparato tiene {{hereMovements}} ahora, y serán sustituidos por los de la copia.",
      confirmNoDate:
        "La copia guarda {{copyMovements}}. Este aparato tiene {{hereMovements}} ahora, y serán sustituidos por los de la copia.",
      ...
      maisNovaQueOApp:
        "Esta copia vino de una versión más nueva de la aplicación. Actualice la aplicación e intente de nuevo — traer solo lo que ella entiende dejaría la fábrica sin una parte de sí.",
      ilegivel: "Este archivo no abrió. Puede haber llegado incompleto.",
      referenciasQuebradas:
        "Esta copia es inconsistente y nada fue cambiado. El aparato está como estaba.",
      naoDeuParaGuardar: "No se pudo guardar la copia ahora.",
      semPartilha:
        "Este aparato no sabe compartir archivos. La copia está guardada aquí: {{path}}",
    },
    extract: {
      title: "Extracto",
      ...
      emptyHint:
        "Cada compra, producción, carga y conteo aparece aquí — con el camino de vuelta al lado.",
      ...
      undoBody:
        "Sale del inventario: {{out}}. Vuelve al inventario: {{back}}. Los dos asientos quedan en el historial — nada se borra.",
      nothing: "nada",
      alreadyUndone:
        "Esto ya fue deshecho. Deshacerlo dos veces duplicaría la corrección.",
    ...
    losses: {
      ...
      emptyHint:
        "Cuando algo venza, se derrita o se rompa, regístralo en el insumo — el motivo es lo que hace útil esta pantalla.",
      ...
      firstWindow:
        "primera ventana con pérdida registrada — no hay antes para comparar",
    ...
    orders: {
      ...
      wasDelivered: "marcado como entregado",
      wasCancelled: "cancelado",
      undo: "Deshacer",
      empty: "Ningún pedido abierto",
      emptyHint:
        "Anota lo que pida el cliente. La pantalla de inicio dirá qué falta producir para el día acordado.",
      ...
      cancelBody:
        "El pedido de {{place}} sale de la lista. Nada cambia en el stock: un pedido no mueve cajas.",
    },

    newOrder: {
      free: "libre para esta fecha: {{amount}}",
      freeHint:
        "lo que hay en el congelador menos lo ya prometido hasta ese día",
      ...
      noCustomers:
        "Todavía no hay tiendas ni clientes. Toca para dar uno de alta.",
      ...
      confirmBody:
        "Vas a anotar {{items}} para {{place}}, {{when}}. Nada sale del stock ahora.",
    ...
    account: {
      ...
      checkEmail:
        "Cuenta creada. Confírmela con el enlace que llegó a su correo y vuelva aquí para entrar.",
      companyTitle: "Su empresa",
      companyBody:
        "Falta ponerle nombre. Es el que aparece arriba en la app y en los informes.",
      ...
      joinSent:
        "Pedido enviado a {{company}}. Espere que alguien de allí lo apruebe.",
      waitingTitle: "Esperando por usted",
      waitingNone: "Nadie pidió entrar.",
      approve: "Aprobar",
      refuse: "Rechazar",
      approveAs:
        "entra como operador — produce, despacha y verifica, sin ver dinero",
      ...
      adoptRefuse: {
        idVazio:
          "La empresa volvió sin identificación del servidor. Salga y entre en la cuenta otra vez.",
        jaSubiu:
          "Este aparato ya mandó datos a un servidor, y lo que subió no se reescribe. " +
      ...
      reason: {
        semServidor:
          "Esta aplicación no tiene servidor configurado. Solo el aparato, por ahora.",
        semRede:
          "No se alcanzó el servidor. Revise la conexión e intente de nuevo.",
        credenciais: "El correo o la contraseña no coinciden.",
        emailEmUso:
          "Ya existe una cuenta con este correo. Entre en vez de crear.",
        senhaFraca:
          "La contraseña es muy corta. Use al menos 6 letras o números.",
        emailNaoConfirmado:
          "Falta confirmar el correo. Busque el enlace que mandó el servidor.",
        codigoNaoConfere:
          "Ese código no pertenece a ninguna empresa. Revise las seis letras.",
    ...
    weatherPlace: {
      ...
      offline:
        "Sin internet ahora. Buscar una ciudad la necesita; el resto de la aplicación no.",
    ...
    settings: {
      ...
      clearByAreaHint:
        "Un área a la vez, cuando quieras rehacer solo una parte.",
      areas: {
      ...
      blocked: {
        recipesUseInputs: {
          ...
          other:
            "No se pueden borrar los insumos mientras {{n}} recetas los usan. Borra las recetas primero.",
        },
        purchasesUseInputs: {
          one: "No se pueden borrar los insumos mientras 1 compra registrada apunta a ellos. Borra las compras primero.",
          other:
            "No se pueden borrar los insumos mientras {{n}} compras registradas apuntan a ellos. Borra las compras primero.",
        },
        productsUseRecipes: {
          one: "No se pueden borrar las recetas mientras 1 producto se hace con ellas. Borra los productos primero.",
          other:
            "No se pueden borrar las recetas mientras {{n}} productos se hacen con ellas. Borra los productos primero.",
        },
      ...
      alsoPurchases:
        "Esto borra {{what}}, y pone en cero el costo promedio de todos los insumos — quedan sin precio hasta la próxima factura. El movimiento es el registro de todo lo que entró y salió: producción, conteos, pérdidas y traslados se van con él.",
      alsoRecipes:
        "Esto borra {{what}}, con todas sus versiones y líneas. El historial de versiones se va con ellas.",
      alsoInputs:
        "Esto borra {{what}}, junto con su costo promedio y su historial de precio.",
      alsoAll:
        "Esto borra {{what}}. La aplicación vuelve a abrir vacía, y los datos de ejemplo no vuelven solos.",
      counted: {
        inputs: { one: "1 insumo", other: "{{n}} insumos" },
        movements: {
          one: "1 movimiento del libro mayor",
          other: "{{n}} movimientos del libro mayor",
        },
        ...
        people: {
          one: "1 persona registrada",
          other: "{{n}} personas registradas",
        },
      ...
      language: {
        ...
        currency: "Moneda",
        currencyHint:
          "Decide el símbolo Y cómo se escribe el número. El ejemplo al lado es la misma cantidad en cada una.",
      },
      appearance: {
        ...
        lightHint:
          "El claro es lo normal. Elige el oscuro para la cámara fría, o deja que el teléfono decida.",
        peles: {
          papel: { nome: "Papel", dica: "serifa, trazo fino, esquinas rectas" },
          organico: {
            nome: "Orgánico",
            dica: "paisaje, curva, esquinas suaves",
          },
        },
        palette: "El color del paisaje",
        paletteHint:
          "Cambia el cielo y la colina. Las señales de subida y bajada no cambian — son lectura, no adorno.",
        hues: {
          verde: "Verde",
          azul: "Azul",
          ambar: "Ámbar",
      ...
      alerts: {
        ...
        ambienteHint:
          "Compara con el rango que cargues en la cámara. Sin rango no avisa — la app no sabe cuál es la temperatura buena de tu cámara.",
        notifyFull: "Avisar cuando se llene",
        volumeHint:
          "Compara con el rango que cargues en el ítem. Sin rango, no avisa.",
        hour: "Hora del aviso",
        hourField: "Hora",
        minuteField: "Minuto",
        hourHint:
          "Antes de que empiece el turno. Un aviso de madrugada es un despertador, y un celular que despierta termina silenciado.",
        weekdays: "En qué días",
        everyDay: "todos los días",
        on: "Encendido",
        off: "Apagado",
        never:
          "Este celular no dio permiso de aviso. La app sigue entera — la portada muestra las mismas cuentas.",
      },
      approval: {
    ...
    inputForm: {
      ...
      kindHint: {
        ...
        storeSupply:
          "Vaso, cuchara, servilleta — cuesta dinero en la tienda, pero no entra en receta.",
      },
      ...
      fullLevelHint:
        "Solo si quieres la lectura por color: rojo, amarillo, verde, azul. Vacío, el ítem no recibe color ni aviso de volumen.",
      ...
      conversionDiffers:
        "El empaque dice {{pack}} {{unit}} y el campo dice {{typed}}. Revísalo.",
      fillFirst:
        "Completa cuánto viene dentro y el precio para que la aplicación calcule el costo por unidad de uso.",
      fillInside:
        "Falta cuánto viene dentro del empaque: es por lo que se divide el precio.",
      fillPrice:
        "Falta el precio pagado. Con él la aplicación calcula el costo por unidad de uso.",
    ...
    inputDetail: {
      ...
      buyCalmWhy:
        "Quedan {{cover}} de existencia, y la cuenta ya considera el plazo del proveedor.",
      leadTimeUnknown:
      ...
      lossHint:
        "Regístralo con el motivo. El motivo es lo que hace que el informe sirva para decidir.",
      ...
      lossBody:
        "Esto baja {{amount}} de {{item}}: {{reason}}. Vale {{money}}, y queda en el historial.",
      lossBodyNoMoney:
        "Esto baja {{amount}} de {{item}}: {{reason}}. Queda en el historial.",
      ...
      entriesHint:
        "Toque un registro para deshacerlo. Nada se borra: la corrección entra como línea nueva, y las dos quedan.",
      undone: "ya corregido",
      ...
      undoDoneBody:
        "Su corrección ya está registrada. No se corrige dos veces.",
      ...
      historyHint:
        "Nadie escribió esto. Cada línea nació de una factura registrada.",
      historyEmpty:
        "Solo hubo una compra hasta ahora, así que todavía no hay con qué comparar.",
      usedBy: "Quién lo usa",
      usedByOne: "Una receta depende de este ítem.",
      usedByMany:
        "{{count}} recetas dependen de este ítem — un aumento aquí las mueve todas.",
    ...
    places: {
      ...
      factory: "Fábrica",
      empty:
        "Todavía no entró nada en ningún lugar. Registra una compra o una producción.",
      worth: "vale {{amount}}",
      itemCount: { one: "un artículo", other: "{{n}} artículos" },
      placeCount: { one: "en 1 lugar", other: "en {{n}} lugares" },
      agreement: "Lo que quedó acordado",
      agreementHint:
        "Nada aquí es obligatorio — sin acuerdo, la tienda recibe cuando se puede.",
      ...
      prices: "LO QUE PAGA",
      pricesHint:
        "En blanco vale el precio de lista. Lo que escribas acá le gana a la lista, solo para este lugar.",
      listPrice: "lista {{amount}}",
      noListPrice: "sin precio de lista",
      priceWas: "era {{amount}} hasta {{date}}",
      pricePerUnit: "por {{unit}}",
      agreementNoteHint:
        "Una frase: dónde descargar, con quién hablar, qué evitar.",
      noAgreement: "sin acuerdo de día",
      agreedDays: "entrega {{days}}",
      reading: "Temperatura ahora",
      readingHint:
        "Anótala cuando pases por la cámara. Se vuelve historial — y cuando llegue el sensor, escribe en el mismo lugar.",
      ...
      rangeHint:
        "Sin rango la app registra y no juzga — no sabe cuál es la temperatura buena de tu cámara.",
      rangeMin: "mínima",
      rangeMax: "máxima",
      ...
      onlyAdminEdits:
        "Registrar y renombrar lugares es de quien administra la empresa.",
      ...
      placeNameHint:
        "El nombre que usa el equipo. Se puede cambiar después sin tocar saldos.",
    ...
    transport: {
      ...
      emptyHint:
        "Lo que salga a una tienda o a un cliente aparece aquí, por destino.",
    ...
    capabilities: {
      view_cost: {
        label: "Ver costo",
        hint: "Cuánto cuesta hacer, y cuánto vale lo que está parado.",
      },
      view_sale_price: {
        label: "Ver precio de venta",
        hint: "Por cuánto sale la mercadería para la tienda o el cliente.",
      },
      record_production: {
        label: "Registrar producción",
        hint: "Anotar lo que salió de la paila, descontando el insumo.",
      },
      dispatch: {
        label: "Despachar carga",
        hint: "Mandar mercadería de la fábrica a una tienda.",
      },
      check_receipt: {
        label: "Revisar la llegada",
        hint: "Abrir la caja en la tienda y decir qué vino.",
      },
      record_loss: {
        label: "Registrar pérdida",
        hint: "Anotar lo que se derritió, se rompió o venció.",
      },
      place_order: {
        label: "Anotar pedido",
        hint: "Pedir a la fábrica en nombre de una tienda.",
      },
      approve_order: {
        label: "Aprobar pedido",
        hint: "Dejar que un pedido se vuelva carga.",
      },
      adjust_stock: {
        label: "Contar el estante",
        hint: "Contar lo que hay y grabar la diferencia.",
      },
      view_finance: {
        label: "Ver el dinero",
        hint: "Cuánto entró, cuánto salió y cuánto está parado.",
      },
      issue_invoice: {
        label: "Emitir factura",
        hint: "Hacer la factura de la carga.",
      },
      manage_company: {
        label: "Administrar la empresa",
        hint: "Dar de alta gente, perfiles, tiendas y equipos.",
      },
    },
    ...
    people: {
      ...
      emptyHint:
        "Da de alta a quien trabaja aquí para poder decir, después, quién tenía el equipo.",
      ...
      readOnly:
        "Solo quien administra la empresa cambia quién trabaja en ella.",
      awayHint:
        "Sale de la lista y el historial sigue apuntando a ella — nada se borra.",
    ...
    transfer: {
      ...
      closeBody:
        "Lo que salió hoy para esa tienda cubre {{count}} abiertos. Cerrar lo quita de la lista de separación y de lo que falta producir.",
      closeAction: "Cerrar",
      ...
      returnBody:
        "Vas a traer {{amount}} de {{item}} de vuelta de {{place}} a la fábrica.",
      ...
      orderedPartly:
        "pedido para {{date}}: {{amount}} — ya fueron {{sent}} hoy",
      title: "Transferir",
      overline: "lo que sale de la fábrica",
      returnReason: "Por qué volvió",
      returnReasonHint:
        "La respuesta cambia qué hacer: no se vendió manda producir menos; se derritió manda revisar el camión.",
      unsold: "No se vendió",
      ...
      notASale:
        "Tienda propia es transferencia, no venta: aquí no hay facturación ni margen. El valor solo cambia de sala.",
      ...
      promisedMany:
        "{{amount}} de eso ya tiene dueño: {{place}} espera {{when}}, y {{rest}} más",
      ...
      confirmShort:
        "Después de esta carga faltan {{amount}} para quien espera.",
      send: "Registrar la transferencia",
      sending: "Registrando…",
      confirmTitle: "Confirmar la transferencia",
      confirmBody:
        "Vas a mandar {{amount}} de {{item}} de {{from}} a {{to}}. El saldo sale de un lugar y entra en el otro; la empresa sigue con lo mismo.",
      confirmAction: "Mandar",
    ...
    production: {
      ...
      nothingYet:
        "Nada registrado hoy todavía. Toca agregar cuando cierre la primera caja.",
      ...
      pick: "Qué produjiste",
      noRecipes:
        "Ningún producto tiene ficha técnica todavía. Cargá primero la receta.",
      batches: "Cuántas pailas",
      batchesHint:
        "Cada vez rinde {{yield}}. Esto es lo que decide cuánto insumo sale del almacén.",
      units: "Cuántas unidades salieron",
      packedAs: "da {{packed}}",
      unitsHint:
        "Lo que salió de verdad. Si rindió menos de lo previsto, la merma aparece acá.",
      ...
      confirmBodyNoBatchNoCost:
        "Produjiste {{units}} de {{product}}. Eso descuenta {{lines}} del stock.",
      recorded: "Producción registrada.",
      open: "Empezar ahora",
      openHint:
        "Márcala ahora y ciérrala cuando salga, o registra todo de una vez.",
      ...
      missingElsewhere:
        "Hay {{item}}: {{where}}. Tráelo al almacén antes de correr.",
      missingIn: "en",
    },
    purchase: {
      title: "Nueva compra",
      ...
      conversion:
        "{{packs}} × {{factor}} = {{baseUnits}} {{unit}} entrando al almacén.",
      total: "Total de la factura",
      perPack: "{{price}} por {{pack}}",
      beforeClosing: "ANTES DE CERRAR",
      firstPurchase:
        "Primera compra de este ítem. La próxima ya trae la comparación.",
      ...
      averageMoves:
        "El costo promedio de {{name}} pasa de {{from}} a {{to}} por cada 1.000 {{unit}}.",
    ...
    recipes: {
      ...
      empty:
        "Ninguna ficha técnica todavía. Carga los insumos primero, después la receta que los usa.",
      ...
      orderedByBatch:
        "En orden de cuánto cuesta el lote — la más cara primero, que es donde mover rinde más.",
    },
    ...
    recipe: {
      ...
      cheaperThan:
        "{{amount}} por unidad contra la versión {{version}} ({{percent}})",
      roundUp:
        "Produce {{rounded}} para cerrar caja llena — sobran {{loose}} sueltas en {{units}}.",
      why: "¿POR QUÉ?",
      ...
      summaryCheaper:
        "Queda {{amount}} por unidad respecto a la versión {{version}}.",
      summaryDearer:
        "Sube {{amount}} por unidad respecto a la versión {{version}}.",
    ...
    catalog: {
      duplicate:
        "Ese nombre ya está registrado. Mayúsculas y espacios no cuentan como diferencia.",
      ...
      typesTitle: "Tipos",
      typesHint:
        "lo que divide la línea: Tradicional, Bañada, Top — o 240 ml, 500 ml, 1 litro",
      flavors: "Sabores",
      ...
      noLines:
        "Ninguna línea todavía. Empieza por la más obvia: ¿qué fabricas todos los días?",
      noTypes:
        "Ningún tipo en esta línea. Sin tipo también funciona — el producto queda línea y sabor.",
      ...
      typeFromAnotherLine:
        "Ese tipo es de otra línea. Elige su línea o un tipo de esta.",
    },
    ...
    productForm: {
      ...
      resale: "Reventa",
      madeHint:
        "El costo viene de la receta y se actualiza solo cuando un insumo cambia de precio.",
      resaleHint:
        "El costo viene de la factura de compra, por el costo promedio de los proveedores.",
      whichRecipe: "Hecho con qué receta",
      loading: "Cargando…",
      noRecipes:
        "Ninguna receta cargada todavía — carga la ficha técnica antes.",
      ...
      perUnitShort: "/ un",
      packagingHint:
        "El empaque cuesta por unidad, no por receta — diluirlo en el lote esconde el margen.",
      fromStock: "Lo que sale del inventario por unidad",
      fromStockCost:
        "el empaque listado cuesta {{amount}} por unidad, según las notas de compra",
      perUnitOf: "Cuánto de {{item}} por unidad",
      howPacked: "Cómo se empaca",
      howPackedHint:
        "El inventario cuenta siempre en unidad; las pantallas hablan en tu empaque.",
      ...
      unitCost: "COSTO POR UNIDAD",
      mixPlusBoth:
        "{{mix}} de masa + {{stock}} de empaque del inventario + {{packaging}} escrito",
      ...
      confirmMade:
        "{{name}}, hecho con la receta {{recipe}}, {{perUnit}} ml por unidad. {{packaging}}",
      confirmResale: "{{name}}, producto de reventa. {{packaging}}",
      confirmAction: "Cargar",
      gridTaken:
        "Ya existe {{name}} con esa clasificación. Dale línea, tipo o sabor a uno de los dos — el catálogo está en Ajustes.",
  ...
  alertText: {
    insumo: {
      title: "Compra {{subject}}",
      body: "Se acaba en {{amount}} según el consumo de la semana.",
    },
    pedido: {
      title: "{{places}} esperando carga",
      body: "Faltan {{amount}} de {{subject}} para atender.",
    },
    volume: {
      title: "{{subject}} en {{amount}}%",
      body: "De lo lleno que cargaste.",
    },
    validade: {
      title: "Lote {{subject}} vence",
      body: "En {{amount}} — manda ese primero.",
    },
    ambiente: {
