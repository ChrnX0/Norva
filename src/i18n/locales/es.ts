...
export const es: Dictionary = {
  ...
  app: {
    ...
    home: {
      ...
      capaLegend: 'La línea entera — de la producción a la caja que salió.',
      capaLegendStill: 'Parada ahora: nada en producción, nada hecho y nada salió hoy.',
      boxYesterday: 'Ayer',
      ...
      firstStepInput: 'Registra lo que compras',
      firstStepRecipe: 'Registra la ficha técnica',
      firstStepProduct: 'Registra el producto',
      readFailed: 'no se pudo leer el día',
      readFailedBody: 'La portada no logró armar las cuentas de hoy. No se perdió nada: todo lo registrado sigue en el aparato.',
      readFailedAction: 'Leer de nuevo',
    ...
    settings: {
      ...
      safety: {
        ...
        suggest: 'Siempre compraste con {{observed}} de sobra. ¿Avisar con {{suggested}}?',
      ...
      alerts: {
        ...
        kinds: {
          ...
          semMedida: 'Cámara dejó de medir',
        ...
        semMedidaHint: 'Avisa cuando la cámara pasa más tiempo del que elijas sin ninguna lectura. Actívalo si un sensor mide solo; si alguien lo anota a mano, va a avisar todos los fines de semana.',
        staleHours: 'Después de {{hours}} sin lectura',
    ...
    inputDetail: {
      ...
      countConfirmSoldNoPrice:
        'Contaste {{counted}}. El sistema esperaba {{expected}}. Entonces {{diff}} salieron del estante y entran como venta. El ingreso entra por el precio acordado de esta tienda, cuando haya uno. \u00bfSe derriti\u00f3 una parte? Registra la p\u00e9rdida antes de contar.',
    ...
    capabilities: {
      ...
      record_production: { label: 'Registrar producción', hint: 'Anotar lo que salió de la producción, descontando el insumo.' },
    ...
    production: {
      ...
      title: 'Producción',
      overline: 'lo que salió de la producción',
      ...
      batches: 'Cuántas veces se hizo la receta',
    ...
    purchase: {
      ...
      roundsToNothing: 'Aumenta la cantidad: esto da menos de 1 {{unit}} y se pierde al redondear.',
    ...
    buyToday: {
      title: 'Comprar hoy',
      overline: 'según el plazo de cada proveedor',
      loading: 'Revisando el stock…',
      estimate: 'DEBE COSTAR',
      estimateWhy: 'Según la última factura de cada uno. El precio puede haber cambiado — la pantalla de compra compara.',
      estimateNoMoney: 'Son los envases a pedir. El costo no aparece para este acceso.',
      itemCount: { one: '1 ítem', other: '{{n}} ítems' },
      listTitle: 'QUÉ PEDIR',
      howMuch: '{{packs}} × {{pack}} — {{amount}}',
      daysLeft: 'dura {{days}} d',
      dayCount: { one: '1 día', other: '{{n}} días' },
      why: 'Salen {{rate}} por día, quedan {{held}}, {{supplier}} tarda {{lead}} y le compras cada {{cycle}}.',
      whyNoCycle: 'Salen {{rate}} por día, quedan {{held}} y {{supplier}} tarda {{lead}}. Es la primera recompra a él.',
      whyNoSupplier: 'Salen {{rate}} por día y quedan {{held}}. Aún sin proveedor anotado: la cuenta usa la holgura de los ajustes.',
      emptyTitle: 'Nada que comprar hoy',
      empty: 'Todo tiene stock más allá del plazo de su proveedor.',
      emptyWhy: 'Esta lista aparece cuando un insumo llega a su día de pedido. Hasta entonces, todo bien.',
      goToInputs: 'Ver el stock',
    },


    fiz: {
      title: '¿Qué hiciste?',
      overline: 'empieza por el final',
      intro:
        'Di qué salió, con tus palabras. La aplicación va a buscar lo que falta para registrarlo — en el orden en que piensas, no en el orden del registro.',
      what: 'Qué salió',
      whatPlaceholder: 'paleta de frutilla',
      howMany: 'Cuántas unidades',
      howManyHint: 'Puedes dejarlo en blanco y decirlo al registrar.',
      start: 'Continuar',
      doing: 'Dijiste: {{what}}',
      doingWithCount: 'Dijiste: {{what}} — {{count}}',
      chainTitle: 'El camino hasta ahí',
      stepInput: 'Lo que compras',
      stepRecipe: 'La ficha de cómo se hace',
      stepProduct: 'El producto que sale',
      stepProduction: 'Registrar lo que salió',
      missing: 'Falta {{done}} de {{total}}',
      nothingMissing: 'Todo está registrado. Solo falta registrar la salida.',
      go: 'Hacer esto ahora',
      done: 'listo',
      now: 'ahora',
      next: 'después',
      forget: 'No era eso',
      forgetConfirm: '¿Borrar lo que dijiste?',
      forgetBody:
        'La frase es solo un recordatorio del camino. Nada de lo que ya registraste se borra — insumos, fichas y productos quedan.',
      forgetYes: 'Borrar la frase',
      invite: 'O di qué hiciste',
      inviteWithChain: 'Di qué hiciste y yo busco lo que falta',
    },
    ...
    recipeNew: {
      ...
      yieldTitle: 'Cuánto rinde una vez',
    ...
    recipe: {
      ...
      leaveBody: 'La versión {{version}} queda como está. Lo que cambiaste en esta pantalla se pierde.',
      leaveDiscard: 'Salir así',
      save: 'Guardar',
      failedToSave: 'No se pudo guardar',
    },
  ...
  alertText: {
    ...
    validade: {
      title: '{{subject}} vence',
      body: 'Lote {{code}}, en {{amount}} — manda ese primero.',
      titleExpired: '{{subject}} venció',
      expiredBody: 'Lote {{code}}, hace {{amount}} — registra la pérdida.',
    },
    semMedida: {
      title: '{{subject}} dejó de medir',
      body: 'Sin lectura hace {{amount}}. Revisa el sensor — la última midió {{reading}} °{{unit}}.',
    },
    ambiente: {
      title: '{{subject}} fuera del rango',
      aboveMax: '{{amount}} °{{unit}}, y el techo es {{limit}}. Revisa la puerta y el motor.',
      belowMin: '{{amount}} °{{unit}}, y el piso es {{limit}}. Revisa la puerta y el motor.',
      justNow: 'Medición de ahora.',
      measuredAgo: 'Medido hace {{hours}}.',
    },
  },
