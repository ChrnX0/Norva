...
export const ptBR = {
  common: {
    ...
    moneyHiddenWay:
      "Se este aparelho é seu, troque o nome em Quem está com o aparelho.",
  },
  ...
  app: {
    ...
    home: {
      ...
      ordersCoveredDetail:
        "O que foi pedido até {{date}} cabe no que já tem na fábrica.",
      ordersWhy:
        "Pelo que foi pedido até {{date}}, contra o que tem na fábrica. Toque para ver os pedidos.",
      orderCount: { one: "1 pedido", other: "{{n}} pedidos" },
      runningOutWhy:
        "Pela saída dos últimos sete dias. Toque para ver o almoxarifado.",
      levelFull: "cheio",
      levelLasts: "dura {{days}} pelo consumo da semana",
      levelEndsIn: "acaba em {{days}}",
      inputsFine: "Insumos em dia",
      inputsFineDetail:
        "Pelo consumo das últimas semanas, nada acaba nos próximos sete dias.",
      each: "cada um",
      ...
      capaLegendStill:
        "Parada agora: sem tacho aberto, nada feito e nada saiu hoje.",
      boxYesterday: "Ontem",
      ...
      firstDayBody:
        "A capa se enche sozinha conforme a fábrica trabalha: o que saiu hoje, o que está acabando, o que os clientes pediram.",
      firstDayAction: "Lançar a primeira produção",
      copyNeverTitle: "Guarde uma cópia",
      copyNeverBody:
        "Tudo o que a fábrica registrou mora neste aparelho. Se ele quebrar, some junto.",
      copyOldTitle: "Sua cópia tem {{days}} dias",
      copyOldBody:
        "Entraram {{movements}} depois dela — é isso que se perde se o aparelho sumir.",
      copyOldQuiet:
        "Nada entrou depois dela, mas o aparelho continua sendo o único lugar.",
    ...
    reports: {
      ...
      rows: {
        ...
        mirror: {
          label: "Espelho da Loja",
          detail: "quanto volta de cada uma",
        },
      },
      /**
      ...
      mirror: {
        ...
        emptyHint:
          "Assim que a primeira carga sair, esta tela começa a comparar.",
      },
    },
    ...
    picking: {
      ...
      emptyHint:
        "Sem pedido, a carga é reposição — e a tela de transferir dá conta dela.",
      noPlacesTitle: "Não há para onde mandar ainda",
      noPlacesHint:
        "Separar carga precisa de um destino. Cadastre a primeira loja ou cliente — leva um minuto, e depois é só escolher aqui.",
      ...
      confirmBody:
        "Vão {{count}} de uma vez. O saldo sai da fábrica e entra na loja, um lançamento por item.",
      ...
      clearBody:
        "O que foi contado se perde. Nada foi gravado ainda, então nada é desfeito — o carrinho só volta a ficar vazio.",
    ...
    lotLabel: {
      ...
      findHint:
        "Digite o código que está na caixa — o mesmo que aparece embaixo do quadrado.",
      ...
      reverseBody:
        "Sai do estoque {{out}}. Volta para o almoxarifado {{back}}. Os dois lançamentos ficam no histórico — nada é apagado.",
      ...
      reverseBlockedHint:
        "Traga a carga de volta primeiro, aí a correção passa a valer.",
    ...
    backup: {
      ...
      neverHint:
        "Uma cópia é um arquivo. Guarde onde você já guarda o que importa — conversa sua, e-mail, nuvem.",
      ...
      madeBody:
        "A cópia tem {{movements}} e pesa {{size}}. Agora escolha onde guardá-la.",
      ...
      insideBody:
        "A cópia leva o livro-razão inteiro — o que entrou, o que saiu, custos e fornecedores. Quem abrir o arquivo lê tudo isso: hoje são {{movements}}.",
      insideBodyEmpty:
        "A cópia leva o livro-razão inteiro — o que entrou, o que saiu, custos e fornecedores. Quem abrir o arquivo lê tudo isso.",
      insidePrefs:
        "Suas escolhas vêm junto: cidade do tempo, ordem da capa, como se entra. Num aparelho novo é isso que faz ele parecer o antigo.",
      restoreTitle: "Trazer uma cópia de volta",
      restoreLead:
        "Aparelho novo, ou aparelho formatado. Escolha o arquivo da cópia.",
      ...
      confirmBody:
        "A cópia é de {{when}} e tem {{copyMovements}}. Este aparelho tem {{hereMovements}} agora, e eles serão substituídos pelos da cópia.",
      confirmNoDate:
        "A cópia tem {{copyMovements}}. Este aparelho tem {{hereMovements}} agora, e eles serão substituídos pelos da cópia.",
      ...
      maisNovaQueOApp:
        "Esta cópia veio de uma versão mais nova do aplicativo. Atualize o aplicativo e tente de novo — trazer o que ele entende deixaria a fábrica sem uma parte dela.",
      ilegivel: "Este arquivo não abriu. Ele pode ter chegado incompleto.",
      referenciasQuebradas:
        "Esta cópia está inconsistente e nada foi mudado. O aparelho está como estava.",
      naoDeuParaGuardar: "Não deu para guardar a cópia agora.",
      semPartilha:
        "Este aparelho não sabe partilhar arquivo. A cópia está guardada aqui: {{path}}",
    },
    extract: {
      title: "Extrato",
      ...
      emptyHint:
        "Cada compra, produção, carga e conferência aparece aqui — com o caminho de volta ao lado.",
      ...
      undoBody:
        "Sai do estoque: {{out}}. Volta para o estoque: {{back}}. Os dois lançamentos ficam no histórico — nada é apagado.",
      nothing: "nada",
      alreadyUndone:
        "Isto já foi desfeito. Desfazer duas vezes dobraria a correção.",
    ...
    losses: {
      ...
      emptyHint:
        "Quando alguma coisa vencer, derreter ou quebrar, registre no item — é o motivo que faz esta tela servir.",
      ...
      firstWindow:
        "primeira janela com perda registrada — não há antes para comparar",
    ...
    orders: {
      ...
      emptyHint:
        "Anote o que o cliente pedir. A capa passa a dizer o que falta produzir até o dia combinado.",
      forDate: "para {{date}}",
      ...
      cancelBody:
        "O pedido de {{place}} sai da lista. Nada muda no estoque: pedido não move caixa.",
    },

    newOrder: {
      free: "livre para esta data: {{amount}}",
      freeHint:
        "o que tem no freezer menos o que já foi prometido até esse dia",
      ...
      noCustomers:
        "Nenhuma loja ou cliente cadastrado ainda. Toque para cadastrar.",
      ...
      confirmBody:
        "Você vai anotar {{items}} para {{place}}, {{when}}. Nada sai do estoque agora.",
    ...
    account: {
      ...
      checkEmail:
        "Conta criada. Confirme pelo link que chegou no seu e-mail e volte aqui para entrar.",
      companyTitle: "A sua empresa",
      companyBody:
        "Falta dar um nome. É ele que aparece no topo do aplicativo e nos relatórios.",
      ...
      refuse: "Recusar",
      approveAs:
        "entra como operador — produz, despacha e confere, sem ver dinheiro",
      ...
      adoptRefuse: {
        idVazio:
          "A empresa voltou sem identificação do servidor. Entre e saia da conta e tente de novo.",
        jaSubiu:
      ...
      reason: {
        semServidor:
          "Este aplicativo está sem servidor configurado. Só o aparelho, por enquanto.",
        ...
        senhaFraca:
          "A senha é curta demais. Use pelo menos 6 letras ou números.",
        emailNaoConfirmado:
          "Falta confirmar o e-mail. Procure o link que o servidor mandou.",
        codigoNaoConfere:
          "Esse código não pertence a nenhuma empresa. Confira as seis letras.",
    ...
    weatherPlace: {
      ...
      offline:
        "Sem internet agora. Procurar cidade precisa dela; o resto do aplicativo não.",
    ...
    settings: {
      ...
      blocked: {
        recipesUseInputs: {
          ...
          other:
            "Não dá para apagar os insumos enquanto {{n}} receitas usam eles. Apague as receitas primeiro.",
        },
        purchasesUseInputs: {
          one: "Não dá para apagar os insumos enquanto 1 compra lançada aponta para eles. Apague as compras primeiro.",
          other:
            "Não dá para apagar os insumos enquanto {{n}} compras lançadas apontam para eles. Apague as compras primeiro.",
        },
        productsUseRecipes: {
          one: "Não dá para apagar as receitas enquanto 1 produto é feito delas. Apague os produtos primeiro.",
          other:
            "Não dá para apagar as receitas enquanto {{n}} produtos são feitos delas. Apague os produtos primeiro.",
        },
      ...
      alsoPurchases:
        "Isso apaga {{what}}, e zera o custo médio de todos os insumos — eles ficam sem preço até a próxima nota. O movimento é o registro de tudo o que entrou e saiu: produção, contagem, perda e transferência vão junto.",
      alsoRecipes:
        "Isso apaga {{what}}, com todas as versões e linhas delas. O histórico de versões vai junto.",
      alsoInputs:
        "Isso apaga {{what}}, junto com o custo médio e o histórico de preço deles.",
      alsoAll:
        "Isso apaga {{what}}. O aplicativo volta a abrir vazio, e os dados de exemplo não voltam sozinhos.",
      counted: {
        inputs: { one: "1 insumo", other: "{{n}} insumos" },
        movements: {
          one: "1 movimento do livro-razão",
          other: "{{n}} movimentos do livro-razão",
        },
        ...
        people: {
          one: "1 pessoa cadastrada",
          other: "{{n}} pessoas cadastradas",
        },
      ...
      language: {
        ...
        currency: "Moeda",
        currencyHint:
          "Ela decide o símbolo E o jeito de escrever o número. O exemplo ao lado é a mesma quantia em cada uma.",
      },
      appearance: {
        ...
        lightHint:
          "O padrão é o claro. Escolha o escuro para a câmara fria, ou deixe o aparelho decidir.",
        /**
        ...
        peles: {
          ...
          organico: {
            nome: "Orgânico",
            dica: "paisagem, curva, cantos macios",
          },
        },
        palette: "A cor da paisagem",
        paletteHint:
          "Muda o céu e a colina. Os sinais de alta e de queda não mudam — eles são leitura, não enfeite.",
        hues: {
          verde: "Verde",
          azul: "Azul",
          ambar: "Âmbar",
      ...
      alerts: {
        ...
        ambienteHint:
          "Compara com a faixa que você cadastrar na câmara. Sem faixa, ele não avisa — o app não sabe qual é a temperatura boa da sua câmara.",
        notifyFull: "Avisar quando encher",
        volumeHint:
          "Compara com a faixa que você cadastrar no item. Sem faixa, ele não avisa.",
        hour: "Hora do aviso",
        hourField: "Hora",
        minuteField: "Minuto",
        hourHint:
          "Antes do turno começar. Aviso de madrugada é despertador, e aparelho que acorda a pessoa vira aparelho silenciado.",
        weekdays: "Em que dias",
        everyDay: "todos os dias",
        on: "Ligado",
        off: "Desligado",
        never:
          "Este aparelho não deu permissão de aviso. O aplicativo continua inteiro — a capa mostra as mesmas contas.",
      },
      approval: {
    ...
    inputs: {
      ...
      coverUnknown:
        "sem saída registrada ainda — ninguém sabe quanto tempo isso dura",
    ...
    inputForm: {
      ...
      fullLevelHint:
        "Só se você quiser a leitura por cor: vermelho, amarelo, verde, azul. Vazio, o item não ganha cor nem aviso de volume.",
      ...
      fillInside:
        "Falta quanto vem dentro da embalagem: é por ele que o preço se divide.",
      fillPrice:
        "Falta o preço pago. Com ele o app calcula o custo por unidade de uso.",
    ...
    inputDetail: {
      ...
      buyCalmWhy:
        "Sobram {{cover}} de estoque, e a conta já conta o prazo do fornecedor.",
      leadTimeUnknown:
      ...
      lossHint:
        "Registre com o motivo. É o motivo que faz o relatório servir para decidir.",
      ...
      lossBody:
        "Você vai baixar {{amount}} de {{item}}: {{reason}}. Vale {{money}}, e fica no histórico.",
      /**
       ...
       */
      lossBodyNoMoney:
        "Você vai baixar {{amount}} de {{item}}: {{reason}}. Fica no histórico.",
      ...
      entriesHint:
        "Toque num lançamento para desfazer. Nada é apagado: a correção entra como linha nova, e as duas ficam.",
      undone: "já corrigido",
      ...
      undoDoneBody:
        "A correção dele já está no registro. Não se corrige duas vezes.",
    ...
    places: {
      ...
      factory: "Fábrica",
      empty:
        "Nada entrou em lugar nenhum ainda. Lance uma compra ou registre uma produção.",
      worth: "vale {{amount}}",
      itemCount: { one: "um item", other: "{{n}} itens" },
      placeCount: { one: "em 1 lugar", other: "em {{n}} lugares" },
      agreement: "O que ficou combinado",
      agreementHint:
        "Nada aqui é obrigatório — sem acordo, a loja recebe quando dá.",
       ...
       */
      pricesHint:
        "Em branco vale o preço de tabela. O que você escrever aqui vence a tabela, só para este lugar.",
      listPrice: "tabela {{amount}}",
      noListPrice: "sem preço de tabela",
      priceWas: "era {{amount}} até {{date}}",
      pricePerUnit: "por {{unit}}",
      agreementNoteHint:
        "Uma frase: onde descarregar, com quem falar, o que evitar.",
      noAgreement: "sem acordo de dia",
      agreedDays: "entrega {{days}}",
      reading: "Temperatura agora",
      readingHint:
        "Anote quando passar pela câmara. Vira histórico — e quando o sensor chegar, ele escreve no mesmo lugar.",
      ...
      rangeHint:
        "Sem faixa o app registra e não julga — ele não sabe qual é a temperatura boa da sua câmara.",
      rangeMin: "mínima",
      rangeMax: "máxima",
      ...
      onlyAdminEdits:
        "Cadastrar e renomear lugares é de quem administra a empresa.",
      ...
      placeNameHint:
        "O nome que a equipe usa. Dá para trocar depois sem mexer em saldo.",
    ...
    transport: {
      ...
      emptyHint:
        "O que sair para uma loja ou cliente aparece aqui, por destino.",
    ...
    capabilities: {
      view_cost: {
        label: "Ver custo",
        hint: "Quanto custa fazer, e quanto vale o que está parado.",
      },
      view_sale_price: {
        label: "Ver preço de venda",
        hint: "Por quanto a mercadoria sai para a loja ou para o cliente.",
      },
      record_production: {
        label: "Registrar produção",
        hint: "Lançar o que saiu do tacho, baixando o insumo.",
      },
      dispatch: {
        label: "Despachar carga",
        hint: "Mandar mercadoria da fábrica para uma loja.",
      },
      check_receipt: {
        label: "Conferir chegada",
        hint: "Abrir a caixa na loja e dizer o que veio.",
      },
      record_loss: {
        label: "Registrar perda",
        hint: "Anotar o que derreteu, quebrou ou passou da validade.",
      },
      place_order: {
        label: "Anotar pedido",
        hint: "Pedir para a fábrica em nome de uma loja.",
      },
      approve_order: {
        label: "Aprovar pedido",
        hint: "Deixar um pedido virar carga.",
      },
      adjust_stock: {
        label: "Conferir prateleira",
        hint: "Contar o que tem e gravar a diferença.",
      },
      view_finance: {
        label: "Ver dinheiro",
        hint: "Quanto entrou, quanto saiu e quanto está parado.",
      },
      issue_invoice: {
        label: "Emitir nota",
        hint: "Fazer a nota fiscal da carga.",
      },
      manage_company: {
        label: "Gerir a empresa",
        hint: "Cadastrar gente, perfil, loja e aparelho.",
      },
    },
    ...
    people: {
      ...
      emptyHint:
        "Cadastre quem trabalha aqui para poder dizer, depois, quem estava com o aparelho.",
      ...
      awayHint:
        "Ela sai da lista e o histórico continua apontando para ela — nada é apagado.",
    ...
    transfer: {
      ...
      closeBody:
        "O que saiu hoje para essa loja cobre {{count}} em aberto. Fechar tira da lista de separação e da conta do que falta produzir.",
      closeAction: "Fechar",
      ...
      returnBody:
        "Você vai trazer {{amount}} de {{item}} de volta de {{place}} para a fábrica.",
      ...
      orderedPartly:
        "pedido para {{date}}: {{amount}} — já foram {{sent}} hoje",
      title: "Transferir",
      ...
      returnReasonHint:
        "A resposta muda o que fazer: não vendeu manda produzir menos; derreteu manda olhar o caminhão.",
      unsold: "Não vendeu",
      ...
      notASale:
        "Loja própria é transferência, não venda: não há faturamento nem margem aqui. O valor só muda de sala.",
      ...
      promisedMany:
        "{{amount}} disso já tem dono: {{place}} espera {{when}}, e mais {{rest}}",
      ...
      confirmBody:
        "Você vai mandar {{amount}} de {{item}} de {{from}} para {{to}}. O saldo sai de um lugar e entra no outro; a empresa continua com a mesma coisa.",
      confirmAction: "Mandar",
    ...
    production: {
      ...
      nothingYet:
        "Nada lançado hoje ainda. Toque em adicionar quando a primeira caixa fechar.",
      ...
      noRecipes:
        "Nenhum produto tem ficha técnica ainda. Cadastre a receita primeiro.",
      batches: "Quantas vezes a receita rodou",
      batchesHint:
        "Cada vez rende {{yield}}. É isto que decide quanto de insumo sai do almoxarifado.",
      units: "Quantas unidades saíram",
      packedAs: "dá {{packed}}",
      unitsHint:
        "O que saiu de verdade. Se rendeu menos que o previsto, é aqui que a perda aparece.",
      ...
      open: "Começar agora",
      openHint:
        "Marque que começou e feche quando sair, ou registre tudo de uma vez.",
      ...
      missingElsewhere:
        "Tem {{item}}: {{where}}. Traga para o almoxarifado antes de rodar.",
      missingIn: "na",
    },
    purchase: {
      title: "Nova compra",
      ...
      conversion:
        "{{packs}} × {{factor}} = {{baseUnits}} {{unit}} entrando no estoque.",
      total: "Total da nota",
      ...
      averageMoves:
        "O custo médio de {{name}} passa de {{from}} para {{to}} a cada 1.000 {{unit}}.",
    ...
    recipe: {
      ...
      cheaperThan:
        "{{amount}} por unidade contra a versão {{version}} ({{percent}})",
      roundUp:
        "Produza {{rounded}} para fechar caixa cheia — sobram {{loose}} soltas em {{units}}.",
      why: "POR QUÊ?",
      ...
      summaryCheaper:
        "Fica {{amount}} por unidade em relação à versão {{version}}.",
      summaryDearer:
        "Sobe {{amount}} por unidade em relação à versão {{version}}.",
    ...
    catalog: {
      duplicate:
        "Esse nome já está cadastrado. Caixa e espaço não contam como diferença.",
      ...
      typesTitle: "Tipos",
      typesHint:
        "o que divide a linha: Tradicional, Skimó, Top — ou 240 ml, 500 ml, 1 litro",
      flavors: "Sabores",
      flavorsHint:
        "valem para todas as linhas: morango, chocolate, coco branco",
      addLine: "Nova linha",
      addType: "Novo tipo",
      ...
      noLines:
        "Nenhuma linha ainda. Comece pela mais óbvia: o que você fabrica todo dia?",
      noTypes:
        "Nenhum tipo nesta linha. Sem tipo também funciona — o produto fica só linha e sabor.",
      ...
      typeFromAnotherLine:
        "Esse tipo é de outra linha. Escolha a linha dele ou um tipo desta.",
    },
    ...
    productForm: {
      ...
      perUnitShort: "/ un",
      packagingHint:
        "Embalagem custa por unidade, não por receita — diluir no lote esconde a margem.",
      fromStock: "O que sai do estoque por unidade",
      fromStockCost:
        "a embalagem listada custa {{amount}} por unidade, pelas notas de compra",
      ...
      unitCost: "CUSTO POR UNIDADE",
      mixPlusBoth:
        "{{mix}} de massa + {{stock}} de embalagem do estoque + {{packaging}} digitado",
      ...
      confirmMade:
        "{{name}}, feito da receita {{recipe}}, {{perUnit}} ml por unidade. {{packaging}}",
      confirmResale: "{{name}}, produto de revenda. {{packaging}}",
      confirmAction: "Cadastrar",
      gridTaken:
        "Já existe {{name}} com essa classificação. Dê linha, tipo ou sabor a um dos dois — o catálogo fica em Ajustes.",
  ...
  alertText: {
    insumo: {
      title: "Compre {{subject}}",
      body: "Acaba em {{amount}} pelo consumo desta semana.",
    },
    pedido: {
    ...
    volume: {
      title: "{{subject}} em {{amount}}%",
      body: "Do cheio que você cadastrou.",
    },
    validade: {
      title: "Lote {{subject}} vence",
      body: "Em {{amount}} — mande esse primeiro.",
    },
    ambiente: {
